    ...
    fetch("/api/phishing-detection", {
      ...
      .then((data) => {
        data["result"].length !== 0
          ? setResult("Finish! you can see the report in your profile reports")
        ...
        <Form onSubmit={handleSubmit}>
              ...
              {scoreRange.map((index) => {
                return (
                  <FormControlLabel
                    value={index}
                    control={
                      <Checkbox onChange={handleScoreChange} defaultChecked />
                    }
                    label={index}
                    labelPlacement="top"
                  />
          ...
          <FormControl style={{ float: "right", marginRight: "10%" }}>
            ...
            <RadioGroup
              ...
              onChange={(event) => setScheduleScanning(event.target.value)}
            >
